...
contract PriceDeviationVerifierTest is Test {
    ...
    function _twoPriceSpec(Attestation memory a, Attestation memory b, address customVerifier)
        internal pure returns (AttestationSpec memory spec)
    {
    ...
    function test_PriceWithinDeviation_Passes() public {
        ...
        Attestation memory a = _makeAtt("https://exchange-a.example/btc", "{\"price_usd\":67000.00}");
        Attestation memory b = _makeAtt("https://exchange-b.example/btc", "{\"price_usd\":68000.00}");
    ...
    function test_PriceBeyondDeviation_Reverts() public {
        ...
        Attestation memory a = _makeAtt("https://exchange-a.example/btc", "{\"price_usd\":60000.00}");
        Attestation memory b = _makeAtt("https://exchange-b.example/btc", "{\"price_usd\":66000.00}");
        _fund(abi.encode(_twoPriceSpec(a, b, address(ext))));
    ...
    function test_MissingKey_Reverts() public {
        ...
        Attestation memory a = _makeAtt("https://exchange-a.example/btc", "{\"price_usd\":60000.00}");
        Attestation memory b = _makeAtt("https://exchange-b.example/btc", "{\"value\":60000.00}");
        _fund(abi.encode(_twoPriceSpec(a, b, address(ext))));
